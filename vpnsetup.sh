...
YOUR_IPSEC_PSK='' #generate your psk 
YOUR_USERNAME='' #generate your username
YOUR_PASSWORD='' #generate your pass
...
NET_IFACE=${VPN_NET_IFACE:-'#'} #PLEASE GENERATE YOUR INTERFACE NAME (eth0/eth1 or etc..)
...
#  iptables -I FORWARD 6 -s "$XAUTH_NET" -o "$NET_IFACE" -j ACCEPT
  ...
  iptables -t nat -I POSTROUTING -s "$XAUTH_NET" -o "ens19" -m policy --dir out --pol none -j MASQUERADE
  iptables -t nat -I POSTROUTING -s "$L2TP_NET" -o "ens19" -j MASQUERADE
